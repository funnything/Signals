...
public extension UIControl {
    ...
    fileprivate func getOrCreateSignalForUIControlEvent(_ event: UIControlEvents) -> Signal<()> {
    ...
    fileprivate func handleUIControlEvent(_ uiControlEvent: UIControlEvents) {
        getOrCreateSignalForUIControlEvent(uiControlEvent).fire()
    }
    
    // MARK: - Event handlers
    
    fileprivate dynamic func eventHandlerTouchDown() {
        handleUIControlEvent(.touchDown)
    }
    
    fileprivate dynamic func eventHandlerTouchDownRepeat() {
        handleUIControlEvent(.touchDownRepeat)
    }
    
    fileprivate dynamic func eventHandlerTouchDragInside() {
        handleUIControlEvent(.touchDragInside)
    }
    
    fileprivate dynamic func eventHandlerTouchDragOutside() {
        handleUIControlEvent(.touchDragOutside)
    }
    
    fileprivate dynamic func eventHandlerTouchDragEnter() {
        handleUIControlEvent(.touchDragEnter)
    }
    
    fileprivate dynamic func eventHandlerTouchDragExit() {
        handleUIControlEvent(.touchDragExit)
    }
    
    fileprivate dynamic func eventHandlerTouchUpInside() {
        handleUIControlEvent(.touchUpInside)
    }
    
    fileprivate dynamic func eventHandlerTouchUpOutside() {
        handleUIControlEvent(.touchUpOutside)
    }
    
    fileprivate dynamic func eventHandlerTouchCancel() {
        handleUIControlEvent(.touchCancel)
    }
    
    fileprivate dynamic func eventHandlerValueChanged() {
        handleUIControlEvent(.valueChanged)
    }
    
    fileprivate dynamic func eventHandlerEditingDidBegin() {
        handleUIControlEvent(.editingDidBegin)
    }
    
    fileprivate dynamic func eventHandlerEditingChanged() {
        handleUIControlEvent(.editingChanged)
    }
    
    fileprivate dynamic func eventHandlerEditingDidEnd() {
        handleUIControlEvent(.editingDidEnd)
    }
    
    fileprivate dynamic func eventHandlerEditingDidEndOnExit() {
